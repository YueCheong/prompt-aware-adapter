...
class GroundedDetailDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        image_file = '{}.jpg'.format(info['image_id']) # zy change to avoid path error
...
class CaptionToObjectDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print("CaptionToObject instruction", instruction) # zy modify to avoid print
...
class PhraseToObjectDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        # print("PhraseToObject instruction", instruction) # zy modify to avoid print
